...
def reg():
    ...
    time.sleep(1)
    try:
        to = open('/sdcard/.anum.txt', 'r').read()
    except (KeyError, IOError):
        reg2()

    r = requests.get('https://raw.githubusercontent.com/evildevill/Anum_server/main/server.txt').text
    if to in r:
        ...
        os.system('xdg-open https://www.facebook.com/anum.shehzadi.948011')
        reg()
